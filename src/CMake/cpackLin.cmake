...
# Remove bogus "runtime" component (legacy aie-rt packaging workaround).
# This means we cannot have a runtime component ever in XRT.
...
if (${LINUX_FLAVOR} MATCHES "^(ubuntu|debian|linuxmint)")
  ...
  SET(CPACK_DEBIAN_ALVEO_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_BINARY_DIR}/postinst;${CMAKE_CURRENT_BINARY_DIR}/prerm")
...
elseif (${LINUX_FLAVOR} MATCHES "^(rhel|centos|amzn|fedora|sles|mariner|almalinux|rocky)")
  ...
  SET(CPACK_RPM_ALVEO_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/postinst")
  SET(CPACK_RPM_ALVEO_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/prerm")
